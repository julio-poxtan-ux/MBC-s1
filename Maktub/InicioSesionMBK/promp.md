...
- Nombre del proyecto: [Onboarding - MBK]
...
- Diseño base: Figma 1:1
- Respeta los espaciados y los Tokens de Figma
...
- Archivo html base para layout de otras paginas
- Los objetos las imagenes guardarlas en assets/img
